...
internal class KeyPopups(private val context: Context) {
    ...
    init {
        ...
        previewLabel.textSize = 28f
            previewLabel.setShadowLayer(dp(8).toFloat(), 0f, 0f, accentColor ?: ink)
            previewLabel.setShadowLayer(dp(8).toFloat(), 0f, 0f, accentColor ?: ink)
            previewLabel.setShadowLayer(dp(8).toFloat(), 0f, 0f, accentColor ?: ink)
            previewLabel.setShadowLayer(dp(8).toFloat(), 0f, 0f, accentColor ?: ink)
            previewLabel.setShadowLayer(dp(8).toFloat(), 0f, 0f, accentColor ?: ink)
    ...
    fun showPreview(key: View, text: String, fill: Int, dark: Boolean, textColor: Int? = null, accentColor: Int? = null) {
        runCatching {
            ...
            previewLabel.setTextColor(accentColor ?: ink)
            previewLabel.scaleX = 0.85f
            previewLabel.scaleY = 0.85f
            previewLabel.animate().scaleX(1.15f).scaleY(1.15f).setDuration(120).withEndAction { previewLabel.animate().scaleX(1f).scaleY(1f).setDuration(60).start() }.start()
            previewLabel.setShadowLayer(dp(8).toFloat(), 0f, 0f, accentColor ?: ink)
            previewLabel.setShadowLayer(dp(8).toFloat(), 0f, 0f, accentColor ?: ink)
            previewLabel.setShadowLayer(dp(8).toFloat(), 0f, 0f, accentColor ?: ink)
            previewLabel.setShadowLayer(dp(8).toFloat(), 0f, 0f, accentColor ?: ink)
